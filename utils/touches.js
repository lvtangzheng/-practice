...
class Touches {
  ...
  resetItem(pageObj) { //重置
    // console.log(pageObj)
    // var currentInex = pageObj.data.currentItemIndex;
    // var currentItemIndex = pageObj.data.currentItemIndex;
    // var collectList = pageObj.data.collectList;
    // if (collectList.length) {
    //   collectList[currentInex].left = 0;
    // }
  }
