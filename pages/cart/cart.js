...
Page({
  ...
  checkoutOrder: function () {
    ...
    var checkedGoods = this.data.cartGoods.filter((element, index, array)=> {
      if (element.checked == true) {
        return true;
      } else {
        return false;
  ...
  deleteCart: function () {
    ...
    let productIds = this.data.cartGoods.filter((element, index, array)=> {
      if (element.checked == true) {
        return true;
      } else {
        return false;
    ...
    productIds = productIds.map((element, index, array)=> {
      if (element.checked == true) {
